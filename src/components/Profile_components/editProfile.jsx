import { ModalContent, ModalHeader, ModalBody, Input, Select, SelectItem, Checkbox, Button } from "@nextui-org/react";
    ...
    <>
      <ModalContent>
        <ModalHeader className="flex flex-col gap-1">
          ...
          <p className="text-[#555555] text-[12px] mb-[20px] leading-[23px]">Por favor, complete esta información únicamente si desea que generemos su declaración de renta.</p>
        </ModalHeader>
        <ModalBody className="pb-[40px]">
          ...
          <Button color={formState? "success":"default"} onPress={sendForm}>Envíar</Button>
        </ModalBody>
      </ModalContent>
    </>
  );
